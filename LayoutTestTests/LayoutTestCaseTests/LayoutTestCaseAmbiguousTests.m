...
@interface LayoutTestCaseAmbiguousTests : LYTLayoutTestCase <LYTViewProvider>

@property (nonatomic) NSInteger testFailures;

@end

@implementation LayoutTestCaseAmbiguousTests
...
- (void)testNoFailWithAllowsOverlap {
    self.ambiguousAutolayoutTestsEnabled = NO;
