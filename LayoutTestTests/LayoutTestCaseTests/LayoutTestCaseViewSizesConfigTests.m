...
@interface LayoutTestCaseViewSizesConfigTests : LYTLayoutTestCase <LYTViewProvider>

@end

@implementation LayoutTestCaseViewSizesConfigTests

- (void)setUp {
    [super setUp];

    [LYTConfig sharedInstance].viewSizesToTest = @[
